    ...
    var n = {
        ...
        common: {
            circRef: function(a, b, c) {
                return n.expander('[POINTS BACK TO <strong>' + (b) + '</strong>]', 'Click to show this item anyway',
                function() {
            ...
            depthReached: function(a, b) {
                return n.expander('[DEPTH REACHED]', 'Click to show this item anyway',
                function() {
                    try {
                        this.parentNode.appendChild(p(a, {
                            maxDepth: 1
    ...
    var p = function(j, k) {
        ...
        var m = {
            ...
            domelement: function(b, c) {
                ...
                return l.expanded ? d.node: n.expander('DOMElement (' + b.nodeName.toLowerCase() + ')', 'Click to show more',
                function() {
            ...
            domnode: function(a) {
                ...
                return l.expanded ? b.node: n.expander('DOMNode', 'Click to show more',
                function() {
                    this.parentNode.appendChild(b.node);
                });
            },
            object: function(a, b, c) {
                ...
                var h = (l.expanded || hasRunOnce) ? f.node: n.expander(n.stringify(a), 'Click to show more',
                function() {
            ...
            array: function(b, c, d) {
                ...
                return l.expanded ? f.node: n.expander(n.stringify(b), 'Click to show more',
                function() {
                    this.parentNode.appendChild(f.node);
                });
            },
